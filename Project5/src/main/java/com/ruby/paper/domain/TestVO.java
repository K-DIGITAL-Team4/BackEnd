...
public class TestVO {
	...
	public TestVO(int r_id, BigInteger information_date, int date, String model_name, int car_type, String car_num,
			int driver_code, int daily_distance, int cum_distance, int car_speed, int rPM, int brake_signal,
			double car_location_GPS_X, double car_location_GPS_Y, double global_Positioning_System_GPS_azimuth,
			double accelerationVx, double accelerationVy, int status_code, double rPMS, double aCC, int fS,
			double rPMSR, int aCCR, int sRA) {
		super();
		R_id = r_id;
	...
	public String toString() {
		return "TestVO [R_id=" + R_id + ", information_date=" + information_date + ", date=" + date + ", model_name="
				+ model_name + ", car_type=" + car_type + ", car_num=" + car_num + ", driver_code=" + driver_code
				+ ", daily_distance=" + daily_distance + ", cum_distance=" + cum_distance + ", car_speed=" + car_speed
				+ ", RPM=" + RPM + ", brake_signal=" + brake_signal + ", car_location_GPS_X=" + car_location_GPS_X
				+ ", car_location_GPS_Y=" + car_location_GPS_Y + ", Global_Positioning_System_GPS_azimuth="
				+ Global_Positioning_System_GPS_azimuth + ", accelerationVx=" + accelerationVx + ", accelerationVy="
				+ accelerationVy + ", status_code=" + status_code + ", RPMS=" + RPMS + ", ACC=" + ACC + ", FS=" + FS
				+ ", RPMSR=" + RPMSR + ", ACCR=" + ACCR + ", SRA=" + SRA + "]";
	}
